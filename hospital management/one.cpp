...
{
    cout<<"\t\t\t\t\t1. Dr. Abhay Bansal\t*Eye Specialist"<<endl<<endl;
    cout<<"\t\t\t\t\t2. Dr. Aanya sirohi\t\t*Heart Specialist"<<endl<<endl;
    cout<<"\t\t\t\t\t3. Dr. Abhishek chandak\t\t*Diabetic Specialist"<<endl<<endl;
    cout<<"\t\t\t\t\t4. Dr. Ashutosh dubey\t\t*Heart Surgent"<<endl<<endl;
    cout<<"\t\t\t\t\t5. Dr. Anushri soni\t\t*Eye Specialist"<<endl<<endl;
    cout<<"\t\t\t\t\t6. Dr. Manya\t\t*Diabetic Specialist"<<endl<<endl;
    cout<<"\t\t\t\t\t7. Dr. Mansi\t\t*Medicine Specialist"<<endl<<endl;
    cout<<"\t\t\t\t\t8. Dr. Raju\t*Medicine Specialist"<<endl<<endl;
}
